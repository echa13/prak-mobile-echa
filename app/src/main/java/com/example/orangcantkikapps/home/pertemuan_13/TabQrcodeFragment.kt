...
class TabQrcodeFragment : Fragment() {
    ...
    // Modul Langkah 3: Menangani klik tombol generate
    ...
    // Modul Langkah 3: Fungsi membuat QR Code Bitmap dari string teks
    ...
    // Modul Langkah 3: Hapus binding saat dihancurkan
